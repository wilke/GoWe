...
inputs:
  ...
  code:
    type: string?
    doc: "Genetic code used in translation of DNA sequences. Overrides value in genbank file. [enum: 11, 4, 25] [bvbrc:enum]"
  domain:
    type: string?
    doc: "Domain of the submitted genome. Overrides value in genbank file. [enum: Bacteria, Archaea] [bvbrc:enum]"
    default: "Bacteria"
  import_only:
    type: boolean?
